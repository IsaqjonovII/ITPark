  ...
  return (
    <StyledAbout>
      <main className="main" role="main">
        ...
        <div>
          ...
          <p className="about__text">
            On July 24, 2019 the first <span>IT Park</span> in the Republic of
            Uzbekistan opened its doors in Tashkent. In a given short amount of
            time, IT Parkhas already brought its first fruits in
            the form of 28 new startups, created dozens of projects in the field
            of information technology, as well as trainings, workshops and
            meetings to encourage the youth of our country, their interest in
            this area and develop computer literacy among the population.
          </p>

          <p className="about__text">
            <span>IT Park</span> is a complex of facilities, buildings and
            structures designed to ensure the startup and market access, an
      ...
      <section className="section">
        ...
        <p className="about__text">
          During the first visit of <span>the President of the Republic of Uzbekistan 
          Shavkat Mirziyoyev </span> to the Republic of India, which was held from
          ...
          startups. Thus, it can be noted that <span>IT Park</span> was created
          on the initiative of the President of the Republic of Uzbekistan to
          improve the startup ecosystem and startup projects and their
